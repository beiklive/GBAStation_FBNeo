...
/// @brief Simplified libretro core wrapper for fbneo
...
private:
    ...
    // Shader sources are now free functions in GBAStationShaders.h
...
public:
    ...
    std::vector<GBAStationMemoryMap> m_memoryMaps;
};
