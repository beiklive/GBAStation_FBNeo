...
/// @brief Overlay UI for GBAStation-integrated
#pragma once
...
/// @brief Overlay UI with GBAStation styling
...
public:
    ...
    void SetCore(GBAStationCore *core) { m_core = core; }
    ...
    /// @brief Check if user wants to exit to GBAStation (chainload)
